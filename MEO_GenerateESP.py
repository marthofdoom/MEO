...
MCM_TUNABLES=[
    ...
    ("XP & Balance","XP","fEnchSkillXP","Enchanting skill XP from souls",
     "Multiplier on the Enchanting SKILL experience gained per soul fed to a gem (base 15/35/75/125/200 by soul size). Soul feeding is this list's enchanting practice.",
