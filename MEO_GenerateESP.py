...
MCM_TUNABLES=[
    ...
    ("Loot & Spawns","UI","bAllowUncoveredGenerics","Allow uncovered enchanted loot",
     "ON (default) lets ordinary enchanted loot MEO has no matching gem for keep its enchantment and appear as normal. Turn this OFF to strip those enchantments so nothing enchanted slips past MEO at all. Unique items, artifacts, and quest items are ALWAYS left untouched either way.",
     'b',1,None,None,None,None),
