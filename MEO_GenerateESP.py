...
MCM_TUNABLES=[
    ...
    ("XP & Balance","XP","fFollowerXpShare","Follower gem-XP share",
     "Fraction of the Gem XP from YOUR kills also granted to nearby followers' socketed gems. Followers rarely get kill credit on their own, so without this their gems barely level. 0 = off.",
     'f',0.5,0.0,1.0,0.05,"{2}"),
