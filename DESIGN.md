...
- XP sources:
  ...
  - **Soul feeding** (Soul Feeder perk, skill 40): consume a filled soul gem
    from the Gem Pouch menu to grant XP to one socketed gem — petty 5,
    lesser 12, common 25, greater 60, grand/black 150 (MCM-tunable).
- Default level thresholds (MCM-tunable globals): cumulative 10 / 30 / 70 /
  150 AP to reach II/III/IV/V, then +150 to Master → **birth**: a new
...
- **No station, ever.** The **Gem Pouch** — a lesser power granted at startup
  (plus an MCM-bindable hotkey) — opens the socket menu anywhere: pick a worn
  item → view sockets → insert / remove / feed soul gem.
